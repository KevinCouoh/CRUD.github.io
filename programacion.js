		...
		transaction.executeSql(sql,undefined, function(transaction,result){
			if(result.rows.length){
				...
				for(var i=0; i<result.rows.length; i++){
					...
					precio+' USD$</span></td><td><button type="button" id="A'+id+'" class="btn btn-success" onclick="editar()"><img src="editar.png" /></button></td><td><button type="button" id="A'+id+'" class="btn btn-danger" onclick="eliminarRegistro()"><img src="eliminar.png" /></button></td></tr>');
				}
			}else{
